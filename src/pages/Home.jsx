        ...
        >
          <ThemeIcon
            ...
            style={{
              ...
              color: "#1B2E3D",
              border: "1px solid rgba(27,46,61,0.1)",
              boxShadow: "0 15px 30px rgba(27,46,61,0.08)",
            }}
          >
        ...
        >
          <ThemeIcon
            ...
            style={{
              ...
              color: "#1B2E3D",
              border: "1px solid rgba(27,46,61,0.1)",
              boxShadow: "0 20px 40px rgba(27,46,61,0.1)",
            }}
          >
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      try {
        ...
        setPriceList(
          Array.isArray(pricesRes.data?.data) ? pricesRes.data.data : [],
        );

        const configRes = await api.get("/settings/calculator");
        let loadedConfigs =
          configRes.data?.config || configRes.data?.data?.config || [];
  ...
  const processList = parseCMSArray(pageData.WorkProcess?.content, [
    {
      ...
      desc: "Выезжаем на объект для точного замера.",
    },
    {
      step: "02",
      title: "Дизайн и Смета",
      desc: "Готовим 3D-макет и прозрачную смету.",
    },
    {
      step: "03",
      title: "Производство",
      desc: "Изготавливаем заказ в нашем цеху.",
    },
    {
      step: "04",
      title: "Монтаж",
      desc: "Профессионально монтируем конструкцию.",
    },
  ]);
  ...
  const faqList = parseCMSArray(pageData.Faq?.content, [
    {
      ...
      a: "Стандартные лайтбоксы и баннеры — от 1 до 3 рабочих дней. Сложные объемные буквы — от 5 до 10 дней.",
    },
    {
      q: "Даете ли вы гарантию на работу?",
      a: "Да, мы предоставляем официальную гарантию от 1 года на все световые элементы и металлоконструкции.",
    },
    {
      q: "Выезжаете ли вы на замер бесплатно?",
      a: "Да, выезд инженера-замерщика по городу Алматы осуществляется абсолютно бесплатно.",
    },
    {
      q: "Делаете ли вы согласование с акиматом?",
      a: "Да, мы берем на себя все бюрократические вопросы по получению разрешительных документов.",
    },
  ]);
  ...
  return (
    ...
    >
          ...
          {(transitionStyles) => (
            <ActionIcon
              style={{
                ...
                color: "white",
                border: "none",
                boxShadow: "0 8px 25px rgba(27, 46, 61, 0.15)",
              }}
              ...
              <Group gap="lg">
                <Stack gap={0} align="flex-end" visibleFrom="sm">
                  <Text
                    fw={800}
                    size="lg"
                    style={{ color: "#1B2E3D", lineHeight: 1 }}
                  >
                    +7 708 932 1854
                  </Text>
                  <Group gap={5} mt={4}>
                ...
                <Button
                  ...
                  leftSection={<IconBrandWhatsapp size={18} stroke={1.5} />}
                  visibleFrom="xs"
                >
                  WhatsApp
                </Button>
                <ActionIcon
                  ...
                  variant="outline"
                  style={{
                    borderColor: "rgba(27,46,61,0.15)",
                    color: "#1B2E3D",
                  }}
                  component="a"
                  href="https://wa.me/77089321854"
              ...
              >
                ...
                <motion.div variants={fadeUp}>
                  <Text
                    ...
                    maw={480}
                    lh={1.6}
                    style={{ color: "rgba(27,46,61,0.7)", fontWeight: 500 }}
                  >
                    Изготавливаем вывески, лайтбоксы и металлоконструкции
                    премиум-класса.
                  </Text>
                </motion.div>
              ...
              >
                ...
                <motion.div variants={fadeUp}>
                  <Text
                    ...
                    mt={20}
                    lh={1.5}
                    style={{ color: "rgba(27,46,61,0.8)", fontWeight: 500 }}
                  >
                    Изготавливаем вывески, лайтбоксы и металлоконструкции
                    премиум-класса.
                  </Text>
                  ...
                  <Stack mt={30} gap="sm">
                    <Button
                      ...
                      style={{
                        ...
                        color: "white",
                        fontWeight: 600,
                        boxShadow: "0 10px 20px rgba(27, 46, 61, 0.15)",
                      }}
                      onClick={() =>
                        document
                          .getElementById("contacts")
                ...
                >
                  <Card
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.borderColor = "rgba(27,46,61,0.2)";
                      e.currentTarget.style.transform = "translateY(-8px)";
                      e.currentTarget.style.boxShadow =
                        "0 20px 40px rgba(27, 46, 61, 0.08)";
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    <ThemeIcon
                      ...
                      radius="100%"
                      style={{
                        backgroundColor: "rgba(27,46,61,0.05)",
                        color: "#1B2E3D",
                      }}
                      mb="lg"
                    >
        ...
        <Container size="lg">
          ...
          >
            ...
            >
              ...
              >
                {pageData.WorkProcess?.subtitle ||
                  "Прозрачный процесс от заявки до монтажа"}
              </Text>
              <Title
                order={2}
                style={{
                ...
                >
                  <Paper
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 15px 30px rgba(27,46,61,0.05)";
                    }}
                  >
                    <Text
                      style={{
      ...
      <Box
        ...
        style={{
          backgroundColor: "#FFFFFF",
          borderTop: "1px solid rgba(27,46,61,0.05)",
          borderBottom: "1px solid rgba(27,46,61,0.05)",
        }}
      >
        <Container size="lg">
          <Grid gutter={60}>
            ...
            <Grid.Col span={{ base: 12, md: 5 }}>
              ...
              >
                ...
                <Text
                  ...
                  style={{ color: "rgba(27,46,61,0.6)" }}
                >
                  {pageData.Calculator?.subtitle ||
                    "Укажите параметры для мгновенного расчета стоимости."}
                </Text>

                <Paper
                  p={{ base: "xl", md: 30 }}
                  radius="40px"
                  style={{ backgroundColor: "#1B2E3D", position: "relative" }}
                >
                  {!leadSuccess ? (
                    <Stack gap="lg">
                      {loadingData ? (
            ...
            <Accordion
              ...
              styles={{
                item: {
                  ...
                  "&[data-active]": { borderColor: "#1B2E3D" },
                },
                control: {
                  fontWeight: 600,
                  color: "#1B2E3D",
          ...
          <Grid gutter={{ base: 60, md: 80 }} align="center">
            ...
            <Grid.Col span={{ base: 12, md: 5 }}>
              ...
              >
                ...
                >
                  {pageData.Contacts?.subtitle || "КОНТАКТЫ"}
                </Text>
                <Title
                  order={2}
                  style={{
                      ...
                      <Stack gap="lg">
                        <TextInput
                          ...
                          styles={{
                            input: {
                              backgroundColor: "transparent",
                              border: "1px solid rgba(27,46,61,0.2)",
                            },
                          }}
                        />
                        <TextInput
