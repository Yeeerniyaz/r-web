...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: '"Google Sans", sans-serif', backgroundColor: "#FFFFFF", overflowX: "hidden", color: "#1B2E3D" }}>
      ...
      {/* 1. HERO СЕКЦИЯ */}
      {/* ========================================== */}
      <Box pt={{ base: 20, md: 40 }} pb={{ base: 20, md: 100 }} style={{ backgroundColor: "#FFFFFF", position: "relative" }}>
        
        {/* НАВИГАЦИЯ (Общая для всех версий) */}
        <Container size="lg" style={{ position: "relative", zIndex: 20 }}>
          <Group justify="space-between" align="center" mb={{ base: 20, md: 80 }}>
        ...
        <Container size="lg">
          ...
          <Grid align="center" gutter={60} visibleFrom="md">
            <Grid.Col span={6}>
              <motion.div variants={staggerContainer} initial="hidden" animate="visible">
                ...
                <motion.div variants={fadeUp}>
                  <Title order={1} style={{ color: "#1B2E3D", fontFamily: '"Google Sans", sans-serif', letterSpacing: "-0.5px", fontSize: "clamp(30px, 5vw, 50px)", lineHeight: 1.1, fontWeight: 900 }}>
          ...
          {/* ========================================== */}
          {/* МОБИЛЬНАЯ ВЕРСИЯ (СТЕКЛО НА ВЕСЬ ЭКРАН) */}
          {/* ========================================== */}
          <Box hiddenFrom="md" style={{ position: "relative", minHeight: "calc(100dvh - 110px)", display: "flex", flexDirection: "column" }}>
            
            {/* 3D-ЛОГОТИП НА ЗАДНЕМ ФОНЕ ПО ЦЕНТРУ */}
            <Box style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", zIndex: 1, width: "100%", pointerEvents: "none" }}>
              <HeroIllustration />
            </Box>

            {/* ТЕКСТ В СТЕКЛЯННОЙ КАПСУЛЕ ПОВЕРХ 3D НА ВЕСЬ ЭКРАН */}
            <motion.div variants={staggerContainer} initial="hidden" animate="visible" style={{ position: "relative", zIndex: 10, width: "100%", display: "flex", flex: 1 }}>
              <Paper 
                p="xl" 
                radius="32px" 
                style={{ 
